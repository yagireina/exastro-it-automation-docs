...
#. | 登録画面の共通項目一覧は以下のとおりです。
   ...
   .. table:: 登録画面項目一覧（機器一覧）
      ...
      +--------+--------+--------+--------+-------------------------------------------------+-----------+--------------+-----------------+
      | DNSホスト名                       | {{#:1 こちらに入る説明の記入をお願い致します。}}|           | 手動入力     | 最大長255バイト |   
      |                                   |                                                 |           |              |                 |     
      +--------+--------+--------+--------+-------------------------------------------------+-----------+--------------+-----------------+
...
#. | インタフェース情報画面の項目一覧は以下のとおりです。
   ...
   .. table:: 登録画面項目一覧（インタフェース情報）
      ...
      |                 |                 | 定が必要な場合があります。   |           |              |                 |
      +-----------------+--------+--------+------------------------------+-----------+--------------+-----------------+
      | Ansible-vaultパスワード           | {{#:1 こちらに入る説明の\    | -         | 手動\        | 最大\           |
...
#. | 登録画面の項目一覧は以下のとおりです。
   ...
   .. table:: 登録画面項目一覧（代入値自動登録設定）
      ...
      |                                   |                                                 |           |              |                   |
      +========+========+========+========+=================================================+===========+==============+===================+
      | パラメータシー\ | メニューグルー\ | {{#:1 こちらに入る説明の記入をお願い致します。}}| ○         | リスト選択   | -                 |
      | ト(From)        | プ:メニュー:項目|                                                 |           |              |                   |
      |                 +--------+--------+-------------------------------------------------+-----------+--------------+-------------------+
      |                 |代入順序         | {{#:1 こちらに入る説明の記入をお願い致します。}}|           | 手動入力     | ブランクまたは、\ |
      |                 |                 |                                                 |           |              | 正の整数          |            
      +--------+--------+--------+--------+-------------------------------------------------+-----------+--------------+-------------------+
...
..
   | {{#:1 記載お願い致します。}}  |                               | データリレイストレージパス(ITA)                        | /host_vars                                 |
   +-------------------------------+-------------------------------+--------------------------------------------------------+--------------------------------------------+
   | {{#:2 記載お願い致します。}}  |                               | Conductor インスタンスデータリレイストレージパス(ANS)  | /host_vars                                 |
   +-------------------------------+-------------------------------+--------------------------------------------------------+--------------------------------------------+
...
|
ITA独自変数を利用して作成したファイルの取り扱い{{ ※1 修正のほどお願いいたします。 }}
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
