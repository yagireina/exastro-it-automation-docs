...
#. | 登録画面の共通項目一覧は以下のとおりです。
   ...
   .. table:: 登録画面項目一覧（機器一覧）
      ...
      |                                   |                                                 |           |              |                 |
      +========+========+========+========+=================================================+===========+==============+=================+
      | 管理システム項番                  | 登録情報を識別する一意のIDが自動入力されます。  | -         | 手動入力     | -               |   
      +--------+--------+--------+--------+-------------------------------------------------+-----------+--------------+-----------------+
      | HW機器種別                        | {{#1: こちらに入る説明の記入をお願い致します。}}| -         | リスト選択   | -               |   
      |                                   |                                                 |           |              |                 |     
      +--------+--------+--------+--------+-------------------------------------------------+-----------+--------------+-----------------+
      | ホスト名                          | ホスト名を記入します。                          | ○         | 手動入力     | 最大長255バイト |   
      +--------+--------+--------+--------+-------------------------------------------------+-----------+--------------+-----------------+
      | DNSホスト名                       | {{#2: こちらに入る説明の記入をお願い致します。}}|           | 手動入力     | 最大長255バイト |   
      |                                   |                                                 |           |              |                 |     
      +--------+--------+--------+--------+-------------------------------------------------+-----------+--------------+-----------------+
      ...
      +--------+--------+--------+--------+-------------------------------------------------+-----------+--------------+-----------------+
      | ssh\            | ssh秘密鍵\      | ssh秘密鍵ファイルを指定して鍵認証する場合の\    | -         | ファイル選択 | 最大サイズ\     |   
      | 鍵認証\         | ファイル        | 秘密鍵ファイルを入力します。アップロード\       |           |              | 4Gバイト        |   
      | 情報            |                 | したファイルは暗号化されて保存されます。        |           |              |                 |   
      |                 |                 |                                                 |           |              |                 |   
      |                 |                 | ※登録後はダウンロード不可となります。           |           |              |                 |       
      |                 +--------+--------+-------------------------------------------------+-----------+--------------+-----------------+
      |                 | パスフレーズ    | ssh秘密鍵ファイルにパスフレーズが設定され\      | -         | 手動入力     | 最大長256バイト |   
      |                 |                 | ている場合、パスフレーズを入力します。          |           |              |                 |        
      +--------+--------+--------+--------+-------------------------------------------------+-----------+--------------+-----------------+
      ...
      |        |        |                 |                                                 |           |              |                 |   
      |        |        +--------+--------+-------------------------------------------------+-----------+--------------+-----------------+
      |        |        | WinRM\ | ポート\| WindowsServerにWinRM接続する際\                 | -         | 手動入力     | 説明欄記載\     |   
      |        |        | 接続\  | 番号   | のポート番号を入力します。                      |           |              | のとおり        |   
      |        |        | 情報   |        |                                                 |           |              |                 |   
      |        |        |        |        | 未入力の場合はデフォルト(5985)での\             |           |              |                 |    
      |        |        |        |        | WinRM接続となります。                           |           |              |                 |     
      |        |        |        +--------+-------------------------------------------------+-----------+--------------+-----------------+
      |        |        |        | サーバ\| WinRM接続ポートでhttpsのポート番号を指定した\   | -         | ファイル選択 | 最大サイズ\     |   
      |        |        |        | 証明書 | 場合にサーバﾞ証明書を入力します。               |           |              | 4Gバイト        |   
      |        |        |        |        |                                                 |           |              |                 |    
      ...
      |        |        |        |        |                                                 |           |              |                 |    
      |        +--------+--------+--------+-------------------------------------------------+-----------+--------------+-----------------+
      |        | 接続オプション           | （ssh接続の場合）                               | -         | 手動入力     | 最大長512バイト |   
      |        |                          |                                                 |           |              |                 |   
      ...
      |        |                          | 設定したいオプションを入力します。              |           |              |                 |     
      |        +--------+--------+--------+-------------------------------------------------+-----------+--------------+-----------------+
      |        | インベントリファイル\    | ITAが設定していないインベントリファイルの\      | -         | 手動入力     | 最大長512バイト |   
      ...
      |        |                          | メニューから登録します。                        |           |              |                 |     
      |        +--------+--------+--------+-------------------------------------------------+-----------+--------------+-----------------+
      |        | Ansi\  | インスタンス\   | Ansible Automation Controller がクラスタ構成の\ | -         | リスト選択   | -               |   
...
#. | インタフェース情報画面の項目一覧は以下のとおりです。
   ...
   .. table:: 登録画面項目一覧（インタフェース情報）
      ...
      |                 |                 | 定が必要な場合があります。   |           |              |                 |
      +-----------------+--------+--------+------------------------------+-----------+--------------+-----------------+
      | Ansible-vaultパスワード           | {{#3: こちらに入る説明の\    | -         | 手動\        | 最大\           |
      |                                   | 記入をお願い致します。}}     |           | 入力         | 長64バイト      |
      |                                   |                              |           |              |                 |
      +-----------------+--------+--------+------------------------------+-----------+--------------+-----------------+
...
.. warning:: | **テンプレートの変数定義を読み取るタイミング**
   ...
   | 詳細は「 :ref:`general_operations_about_the_maintenance_method` 」に記載していますので、そちらをご参照ください。
...
#. | 登録画面の項目一覧は以下のとおりです。
   ...
   .. table:: 登録画面項目一覧（Movement一覧）
      ...
      |                                   |                                                 |           |              |                   |
      +========+========+========+========+=================================================+===========+==============+===================+
      | Movement名                        | Movementの名称を入力します。                    | ○         | 手動入力     | 最大長256バイト   |
      +--------+--------+--------+--------+-------------------------------------------------+-----------+--------------+-------------------+
      | 遅延タイマー                      | Movementが指定期間遅延した場合にステータスを\   | -         | 手動入力     | -                 |
      |                                   | 遅延として警告表示したい場合に指定期間(1～)を\  |           |              |                   |
      |                                   | 入力します。(単位:分)                           |           |              |                   |
      |                                   |                                                 |           |              |                   |
      |                                   | 未入力の場合は警告表示しません。                |           |              |                   |
      +--------+--------+--------+--------+-------------------------------------------------+-----------+--------------+-------------------+
      | Ansible利用情報 | ホスト指定形式  | 特別にIPアドレスで表現しないホストを指定したい\ | ○         | リスト選択   | -                 |
      |                 |                 | 場合に「ホスト名」を選択します。                |           |              |                   |
      |                 |                 |                                                 |           |              |                   |
      |                 |                 | 通常はIPが推奨です。                            |           |              |                   |
      |                 +--------+--------+-------------------------------------------------+-----------+--------------+-------------------+
      |                 | WinRM接続       | 対象ホストがWindowsServerの場合に、\            | -         | リスト選択   | -                 |
      |                 |                 | 「●」を選択します。                             |           |              |                   |
      |                 +--------+--------+-------------------------------------------------+-----------+--------------+-------------------+
      |                 | ヘッダー\       | ITAが自動生成する親Playbookの先頭からtasksまた\ | -         | 手動入力     | 最大長512バイト   |
      ...
      |                 +--------+--------+-------------------------------------------------+-----------+--------------+-------------------+
      |                 | オプション\     | Movement固有のオプションパラメータを入力します。| -         | 手動入力     | 最大長512バイト   |
      |                 | パラメータ      |                                                 |           |              |                   |
      ...
      |                 +--------+--------+-------------------------------------------------+-----------+--------------+-------------------+
      |                 | ansible.cfg     | 作業実行時に使用するansible.cfgを\              | -         | ファイル選択 | 最大サイズ4Gバイト|
      |                 |                 | アップロードします。                            |           |              |                   |
      |                 |                 |                                                 |           |              |                   |
      ...
      |                 |                 | 上書きされます。                                |           |              |                   |
      |                 +--------+--------+-------------------------------------------------+-----------+--------------+-------------------+
      |                 | Ansibl\| 実行\  | Ansible Automation Controllerサーバに構築され\  | -         | リスト選択   |                   |
...
#. | 登録画面の項目一覧は以下のとおりです。
   ...
   .. table:: 登録画面項目一覧（代入値自動登録設定）
      ...
      |                                   |                                                 |           |              |                   |
      +========+========+========+========+=================================================+===========+==============+===================+
      | パラメータシー\ | メニューグルー\ | {{#5: こちらに入る説明の記入をお願い致します。}}| ○         | リスト選択   | -                 |
      | ト(From)        | プ:メニュー:項目|                                                 |           |              |                   |
      |                 +--------+--------+-------------------------------------------------+-----------+--------------+-------------------+
      |                 |代入順序         | {{#6: こちらに入る説明の記入をお願い致します。}}|           | 手動入力     | ブランクまたは、\ |
      |                 |                 |                                                 |           |              | 正の整数          |            
      +--------+--------+--------+--------+-------------------------------------------------+-----------+--------------+-------------------+
      | 登録方式                          | Value型:項目の設定値を紐付けた変数の具体値\     | ○         | リスト選択   | -                 |
      |                                   | とする場合に選択します。                        |           |              |                   |
      |                                   |                                                 |           |              |                   |
      ...
      |                                   | は紐付け対象外となります。                      |           |              |                   |
      +--------+--------+--------+--------+-------------------------------------------------+-----------+--------------+-------------------+
      | Movement名                        | Movement一覧で登録したMovementが表示されます。  | ○         | リスト選択   | -                 |
      |                                   |                                                 |           |              |                   |
      |                                   | Movementを選択します。                          |           |              |                   |
      +--------+--------+--------+--------+-------------------------------------------------+-----------+--------------+-------------------+
      | IaC変数(To)     | Movement名\     | Movement-ロール紐付で登録した資材で使用している\| ○         | リスト選択   | -                 |
      |                 | :変数名         | 変数が表示されます。                            |           |              |                   |
      |                 |                 |                                                 |           |              |                   |
      |                 |                 | 具体値に紐付けたい変数を選択します。            |           |              |                   |
      |                 +--------+--------+-------------------------------------------------+-----------+--------------+-------------------+
      |                 | Movement名:変数\| 変数名で多段変数を選択した場合に多段変数の\     | ※1        | リスト選択   |                   |
      |                 | 名:メンバー変数 | メンバー変数が表示されます。                    |           |              |                   |
      |                 |                 |                                                 |           |              |                   |
      |                 |                 | メンバー変数を選択します。                      |           |              |                   |
      |                 +--------+--------+-------------------------------------------------+-----------+--------------+-------------------+
      |                 | 代入順序        | 複数具体値が設定できる変数の場合のみ必須入力\   | ※2        | 手動入力     | ブランクまたは、\ |
      |                 |                 | になります。                                    |           |              | 正の整数          |
      |                 |                 |                                                 |           |              |                   |
      ...
      |                 |                 | も代入順序（1～）を入力します。                 |           |              |                   |
      +--------+--------+--------+--------+-------------------------------------------------+-----------+--------------+-------------------+
      | NULL連携                          | パラメータシートの具体値がNULL(空白)の場合に、\ | ※3        | リスト選択   | -                 |
   ...
   .. | 情報  |       | 別紐付、Movement-ロール紐\ |       | 選択  |             |
   .. |       |       | 付）で登録した資材で使用し\|       |       | またはKey\  |
   .. |       |       | ている変数が表示されます。 |       |       | -Value型を  |
   .. |       |       |                            |       |       |             |
   .. |       |       | Key型で具体値に紐\         |       |       | 選択した\   |
   .. |       |       | 付けたい変数を選択します。 |       |       | 場合は必須  |
   .. |       +-------+----------------------------+-------+-------+-------------+
...
#. | 閲覧画面の項目一覧は以下のとおりです。
   ...
   .. table:: 閲覧画面項目一覧（作業対象ホスト）
      :align: left

      +-------------------+-------------------------------------------------------------------+
      | **項目**          | **説明**                                                          | 
      +===================+===================================================================+
      | 作業No            | {{#7: こちらに入る説明の記入をお願い致します。}}                   |
      +-------------------+-------------------------------------------------------------------+
      | オペレーション    | オペレーション一覧に登録されているオペレーションが表示されます。  |
      +-------------------+-------------------------------------------------------------------+
      | Movement名        | Movement一覧に登録されているMovementが表示されます。              |
      +-------------------+-------------------------------------------------------------------+
      | ホスト名          | 機器一覧に登録されているホスト名が表示されます。                  |
      +-------------------+-------------------------------------------------------------------+
      | 備考              | 自由記述欄です。                                                  |
      +-------------------+-------------------------------------------------------------------+
...
#. | /ベースディレクトリ/ドライバパス/作業番号/out
   ...
   | 作業番号:　{{#11: 作業番号について下記既存通りなのかご確認お願いします。}}
   | 　　　　　 作業実行時の作業番号を右寄せで不足分は0を埋めた10桁の文字列。
...
| {{#12: ansible_ssh_private_key_fileパスとコマンドについて下記既存通りなのかご確認お願いします。}}  
...
Ansible Automation ControllerでITA独自変数を利用する場合の留意事項{{#13: こちらのご確認・修正をお願い致します。}}
--------------------------------------------------------------------------------------------------------------------
...
実行時データ削除で削除されるデータリソース {{#14: こちらの修正をお願い致します。作業番号についてなど}}
---------------------------------------------------------------------------------------------------------
