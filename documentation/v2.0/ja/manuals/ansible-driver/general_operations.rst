...
#. | 登録画面の共通項目一覧は以下のとおりです。
   ...
   .. table:: 登録画面項目一覧（機器一覧）
      ...
      |                 |                 | ※登録後はダウンロード不可となります。           |           |              |                 |       
      |                 +--------+--------+-------------------------------------------------+-----------+--------------+-----------------+
      |                 | パスフレーズ    | ssh秘密鍵ファイルにパスフレーズが設定され\      | -         | 手動入力     | 最大長255バイト |   
      |                 |                 | ている場合、パスフレーズを入力します。          |           |              |                 |        
      +--------+--------+--------+--------+-------------------------------------------------+-----------+--------------+-----------------+
      ...
      |        |        |        |        |                                                 |           |              |                 |    
      |        +--------+--------+--------+-------------------------------------------------+-----------+--------------+-----------------+
      |        | 接続オプション           | （ssh接続の場合）                               | -         | 手動入力     | 最大長4000バイト|   
      |        |                          |                                                 |           |              |                 |   
      ...
      |        |                          | 設定したいオプションを入力します。              |           |              |                 |     
      |        +--------+--------+--------+-------------------------------------------------+-----------+--------------+-----------------+
      |        | インベントリファイル\    | ITAが設定していないインベントリファイルの\      | -         | 手動入力     | 最大長4000バイト|   
...
#. | インタフェース情報画面の項目一覧は以下のとおりです。
   ...
   .. table:: 登録画面項目一覧（インタフェース情報）
      ...
      |                 |                 | 定が必要な場合があります。   |           |              |                 |
      +-----------------+--------+--------+------------------------------+-----------+--------------+-----------------+
      | Ansible-vaultパスワード           | ansible-vaultコマンドで変数\ | -         | 手動\        | 最大\           |
...
#. | 登録画面の項目一覧は以下のとおりです。
   ...
   .. table:: 登録画面項目一覧（Movement一覧）
      ...
      |                 |                 | 「●」を選択します。                             |           |              |                   |
      |                 +--------+--------+-------------------------------------------------+-----------+--------------+-------------------+
      |                 | ヘッダー\       | ITAが自動生成する親Playbookの先頭からtasksまた\ | -         | 手動入力     | 最大長4000バイト  |
      ...
      |                 +--------+--------+-------------------------------------------------+-----------+--------------+-------------------+
      |                 | オプション\     | Movement固有のオプションパラメータを入力します。| -         | 手動入力     | 最大長4000バイト  |
      |                 | パラメータ      |                                                 |           |              |                   |
      ...
      |                 +--------+--------+-------------------------------------------------+-----------+--------------+-------------------+
      |                 | ansible.cfg     | 作業実行時に使用するansible.cfgを\              | -         | ファイル選択 | 最大サイズ100M\   |
      |                 |                 | アップロードします。                            |           |              | バイト            |
      |                 |                 |                                                 |           |              |                   |
...
#. | 登録画面の項目一覧は以下のとおりです。
   ...
   .. table:: 登録画面項目一覧（代入値自動登録設定）
      ...
      |                                   |                                                 |           |              |                   |
      +========+========+========+========+=================================================+===========+==============+===================+
      | パラメータシー\ | メニューグルー\ | メニュー作成機能で作成したパラメータシートの項\ | ○         | リスト選択   | -                 |
      | ト(From)        | プ:メニュー:項目| 目が表示されます。                              |           |              |                   |
      |                 |                 |                                                 |           |              |                   |
      |                 |                 | 対象の項目を選択します。                        |           |              |                   |
      |                 |                 |                                                 |           |              |                   |
      |                 +--------+--------+-------------------------------------------------+-----------+--------------+-------------------+
      |                 |代入順序         | メニュー作成機能で作成したパラメータシートが\   |           | 手動入力     | 1～2147483647     |
      |                 |                 | 縦型メニューの場合、\                           |           |              |                   |            
      ...
      |                 |                 | メンバー変数を選択します。                      |           |              |                   |
      |                 +--------+--------+-------------------------------------------------+-----------+--------------+-------------------+
      |                 | 代入順序        | 複数具体値が設定できる変数の場合のみ必須入力\   | ※2        | 手動入力     | 1～2147483647     |
      |                 |                 | になります。                                    |           |              |                   |
      |                 |                 |                                                 |           |              |                   |
